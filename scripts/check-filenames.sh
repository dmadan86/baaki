...
EXTENSIONS='ts|tsx|js|jsx|mjs|cjs|json|md|sql|prisma|ya?ml|toml|css|html|svg|png|jpg|jpeg|webp|ico|ttf|otf|sh|swift|txt|example|gitignore|gitattributes|npmrc|nvmrc|prettierrc|prettierignore|vercelignore|editorconfig|lock'
