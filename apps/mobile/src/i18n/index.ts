...
const ta: UiStrings = {
  ...
  captures: {
    ...
    splitLaterHint: 'இதை ஒரு குழுவில் சேர்க்கும்போது யார், எப்படிப் பங்கிடுவது என்பதைத் தேர்வு செய்யலாம்.',
...
const hi: UiStrings = {
  ...
  privacy: {
    ...
    licensesIntro:
      'बाकी ओपन-सोर्स सॉफ़्टवेयर पर बना है। इन्हें बनाने और सँभालने वालों का धन्यवाद।',
...
const ar: UiStrings = {
  ...
  captures: {
    ...
    groupPickerBody: 'حدِّد المجموعة التي ينتمي إليها. يمكنك تغييرها — واختيار طريقة التقسيم — عند الإسناد.',
