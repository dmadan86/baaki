...
const ICON_KEYWORDS: ReadonlyArray<readonly [string, readonly string[]]> = [
  ...
  // ---- Work & study -------------------------------------------------------
  ['briefcase-outline', ['office', 'work', 'coworking']],
  ['laptop-outline', ['laptop', 'software', 'saas']],
  ['print-outline', ['print', 'printing', 'xerox']],
  ['document-text-outline', ['document', 'paperwork']],
  ['mail-outline', ['courier', 'postage']],
  ['school-outline', ['school', 'college', 'tuition']],
  ['book-outline', ['book', 'books', 'study', 'course']],
  ['library-outline', ['library']],
  // ---- Home & bills -------------------------------------------------------
  ['home-outline', ['rent', 'deposit']],
  ['flash-outline', ['electricity', 'current', 'power']],
  ['bulb-outline', ['bulb', 'lighting']],
  ['water-outline', ['water']],
  ['flame-outline', ['gas', 'cylinder', 'lpg']],
  ['wifi-outline', ['wifi', 'internet', 'broadband']],
  ['tv-outline', ['dth', 'cable']],
  ['call-outline', ['phone', 'landline']],
  ['shield-checkmark-outline', ['security', 'guard']],
  ['people-outline', ['maid', 'cook']],
  ['person-outline', ['babysitter', 'nanny', 'driver']],
  ...
  ['accessibility-outline', ['wheelchair', 'accessibility']],
  ['happy-outline', ['kids', 'child', 'children']],
  ['medical-outline', ['doctor', 'clinic', 'hospital', 'dentist', 'apollo', 'pharmeasy']],
  ['bandage-outline', ['bandage', 'injury', 'firstaid']],
  ['eye-outline', ['eye', 'optical', 'glasses', 'lens']],
  ['pulse-outline', ['checkup', 'healthcheck']],
  ['fitness-outline', ['yoga']],
  ['barbell-outline', ['gym', 'workout', 'fitness']],
  ['flask-outline', ['lab', 'scan', 'test']],
  ['leaf-outline', ['ayurveda', 'wellness']],
  ['heart-outline', ['insurance', 'therapy']],
  ['medkit-outline', ['medicine', 'medicines', 'pharmacy', 'chemist']],
  // ---- Gifts --------------------------------------------------------------
  ['flower-outline', ['flowers', 'bouquet']],
  ['balloon-outline', ['party', 'celebration']],
  ['sparkles-outline', ['decor', 'decoration']],
  ['ribbon-outline', ['award', 'prize']],
  ['trophy-outline', ['tournament', 'competition']],
